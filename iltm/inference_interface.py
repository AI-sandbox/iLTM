...
class _iLTMBase(BaseEstimator):
    ...
    def __init__(
        ...
        *,
        ...
        tree_lr: float | None = 0.55,
        tree_max_depth: int | None = 5,
        tree_min_samples_leaf: int | None = 12,
        tree_subsample: float | None = 0.63,
        tree_feature_fraction: float | None = 0.99,
