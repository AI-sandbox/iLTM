...
class _iLTMBase(BaseEstimator):
    ...
    def __init__(
        ...
        *,
        ...
        finetuning_optimizer: str = 'lion',
        finetuning_data: str = 'entire_dataset',
        finetuning_val_frac: float = 0.1,
        finetuning_batch_size: int | None = 2048,
        finetuning_dropout: float = 0.15,
        finetuning_max_steps: int = 2048,
        finetuning_lr: float = 0.00025,
        ...
        scheduler_min_lr: float = 0.000002,
        checkpoint: str | None = "cbrconcat",
        ...
        tree_embedding: bool = True,
        tree_model: str = 'CatBoost',
        tree_n_estimators: int = 125,
        tree_lr: float | None = 0.4,
        tree_max_depth: int | None = 5,
        tree_min_samples_leaf: int | None = 12,
        tree_subsample: float | None = 0.5,
        tree_feature_fraction: float | None = 0.9,
        tree_data_split: str = 'all',
        ...
        concat_tree_with_orig_features: bool = True,
        tree_max_leaves: int | None = None,
        tree_gamma: float | None = 0.05,
        tree_l2_leaf_reg: float | None = 3.0,
